define([], function() {
  return {
    ...
    "step2body": "To change the <b>page language</b>, pick English or French. The language of headings and menus in GCXchange can only be changed in your MS365 Account\'s <b>language & region</b> settings. For more information, visit our <a href=\"https://gcxchange.sharepoint.com/sites/Support/SitePages/FAQ.aspx\">FAQ<a/>",
    "step3header": "Enjoy!",
